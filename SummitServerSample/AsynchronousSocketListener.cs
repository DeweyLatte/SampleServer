...
namespace SummitServerSample
{
    ...
    public class AsynchronousSocketListener
    {
        ...
        public AsynchronousSocketListener(int p_port)
        {
            serverPort = p_port;
        }
        ...
        internal void SetUpDelegateRec(Func<Socket, String, int> DummyDelegateReceive)
        {
            ManagerFuncRec = DummyDelegateReceive;
        }
    }
}
